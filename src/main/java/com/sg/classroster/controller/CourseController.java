...
public class CourseController {
    ...
    @Autowired
    public CourseController(TeacherDao teacherDao, StudentDao studentDao, CourseDao courseDao) {
    ...
    public String performEditCourse(@Valid Course course, BindingResult result, HttpServletRequest request, Model model) {
        ...
        if (studentIds != null) {
            ...
            FieldError error = new FieldError("course", "students", "Must include at least one student");
